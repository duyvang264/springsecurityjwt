...
import usermanager.payload.request.SigninRequest;
import usermanager.payload.request.SignupRequest;
import usermanager.payload.response.JwtResponse;
import usermanager.payload.response.MessageResponse;
import usermanager.repository.RoleRepository;
import usermanager.repository.UserRepository;
import usermanager.securityjwt.JwtUtils;
...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		Set<RoleEntity> roles = userService.setRoles(signUpRequest.getRole());
